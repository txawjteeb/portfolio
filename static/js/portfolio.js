$(document).ready(function(){
	...
	$('#wrapper').on('click','.project_link', function(e){
		...
		preview_pane.html('<iframe src="'+ $(this).attr('href') +'" frameborder="0" width="100%" height="600px"></iframe>');
	...
	$('.project_list').each(function(){
		...
		preview_pane.html('<iframe src="'+ list_item.attr('href') +'" frameborder="0" width="100%" height="600px"></iframe>');
